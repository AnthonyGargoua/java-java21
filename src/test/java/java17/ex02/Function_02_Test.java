 ...
 // BiFunction<Person, Integer, Account> buildAccount = null;
    ...
    public void test_build_account() throws Exception {
     ...
     // Account account = null;
        ...
        Account account = buildAccount.apply(person, 500); // J'exécute la fonction 'buildAccount' en lui passant le nombre 500 grâce à la méthode double .apply(person, 500)
